...
# 	Board Config
#################################################
export LF_ORIGIN_BOARD_CONFIG=BoardConfig-SPI_NAND-Buildroot-RV1106_Luckfox_Pico_Pro_Max-MinCMA.mk
# Target CHIP
...
export RK_PARTITION_CMD_IN_ENV="256K(env),256K@256K(idblock),512K(uboot),4M(boot),100M(rootfs)"
...
export RK_CAMERA_SENSOR_IQFILES="mis5001_CMK-OT2115-PC1_30IRC-F16.json"
